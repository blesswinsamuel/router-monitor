...
ssh -p 2244 pi@router.home.local "sudo -E /tmp/network_traffic_exporter -listen 0.0.0.0:9154 -l4 -interface lan -bpf 'src net 192.168.1.0/24 or dst net 192.168.1.0/24'"
